...
1. 权重和 scale 的影响能否量化？
现在调参 主要依赖观察和枚举，成本比较高。后面可以考虑引入一些自动指标：
...
使用 mink.solve_ik() 求解机器人当前帧的 qpos。
...
————————————————
版权声明：本文为CSDN博主「CyanMind」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/CyanNoah/article/details/160863273